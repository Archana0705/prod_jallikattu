...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $R_status = 'A3';
    $fwdTo = 'Principal Secretary/Additional Chief Secretary';
    $sql = "UPDATE TNEA_JALLIKATTU_EVENT_REGISTERATION_T SET Request_status = :REQUEST_STATUS, DAH_VS_COMMENTS = :P19_DAH_VS_COMMENTS, forward_to = :forward,updated_by=:app_employee_id WHERE EVENT_ID = :P19_EVENT_ID;";
    ...
    $bind->bindParam(':P19_DAH_VS_COMMENTS', $comments);
