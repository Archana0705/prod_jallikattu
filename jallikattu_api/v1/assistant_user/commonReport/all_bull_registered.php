...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT ROW_NUMBER() OVER () AS rownum, C.* FROM (select BULLS_ID,EVENT_TYPE,EVENT_DATE,PLACE_OF_EVENT,DISTRICT,STATUS,CREATED_BY,CREATED_DATE,UPDATED_DATE,UPDATED_BY,SELECTED_BULL,MOBILE,REQUEST_STATUS from TNEA_JALLIKATTU_BULL_EVENT_T) C; ";
