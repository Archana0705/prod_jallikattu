...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE TNEA_JALLIKATTU_EVENT_REGISTERATION_T SET Request_status = :REQUEST_STATUS, ASSISTANT_REMARKS=:P19_ASSISTANT_REMARKS,forward_to= :forward WHERE EVENT_ID = :P19_EVENT_ID;";
