...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT BULLS_ID,EVENT_TYPE,EVENT_DATE,PLACE_OF_EVENT,DISTRICT,STATUS,CREATED_BY,CREATED_DATE,UPDATED_DATE,UPDATED_BY,SELECTED_BULL,MOBILE from TNEA_JALLIKATTU_BULL_EVENT_T WHERE CREATED_BY=:APP_EMPLOYEE_ID;";
