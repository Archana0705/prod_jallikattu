...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT distinct(Initcap(e.NAME_OF_DISTRICT)) as d,initcap(e.NAME_OF_DISTRICT) as r from TNEA_JALLIKATTU_EVENT_REGISTERATION_T e, TNEA_JALLIKATTU_EVENT_GO_T g WHERE g.NAME_OF_DISTRICT = e.NAME_OF_DISTRICT AND e.request_status in ('GO1', 'C')  AND g.EVENT_ID= e.EVENT_ID AND e.EVENT_TYPE = :P97_EVENT_TYPE ORDER BY 1;";
