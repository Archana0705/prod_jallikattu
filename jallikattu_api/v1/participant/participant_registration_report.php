...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT PART_ID,EVENT_TYPE,EVENT_DATE,PLACE_OF_EVENT,DISTRICT,SELECT_PART,MOBILE_NUMBER,STATUS,CREATED_BY,CREATED_DATE,UPDATED_DATE,UPDATED_BY from TNEA_JALLIKATTU_PART_EVENT_T where created_by=:app_employee_id;";
