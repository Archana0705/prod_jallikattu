...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT DISTINCT a.District_name d, a.District_name r FROM TNEA_JALLIKATTU_ADDRESS_TB a, TNEA_JALLIKATTU_APPROVER_LOGIN_T l WHERE a.district_name = l.district AND l.Approver_id = :App_employee_id order by 1;";
