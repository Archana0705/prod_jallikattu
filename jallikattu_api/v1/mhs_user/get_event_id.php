...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT  EVENT_ID d, Event_ID r FROM TNEA_JALLIKATTU_EVENT_REGISTERATION_T WHERE NAME_OF_DISTRICT = :P70_DISTRICT AND NAME_OF_TALUK = :P70_TALUK;";
    $stmt = $jk_read_db->prepare($sql);
    $stmt->bindParam(':P70_DISTRICT', $district);
    $stmt->bindParam(':P70_TALUK', $taluk);
    if ($stmt->execute()) {
