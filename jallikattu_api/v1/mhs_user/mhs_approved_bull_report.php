...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT b.BULLS_ID, b.EVENT_TYPE, b.EVENT_DATE, b.PLACE_OF_EVENT, b.DISTRICT, b.STATUS, b.CREATED_BY, b.CREATED_DATE, b.UPDATED_DATE, b.UPDATED_BY, b.SELECTED_BULL, b.MOBILE from TNEA_JALLIKATTU_BULL_EVENT_T b,TNEA_JALLIKATTU_APPROVER_LOGIN_T a where a.district = b.DISTRICT AND B.REQUEST_STATUS ='AB' and a.approver_id=:app_employee_id Order by b.EVENT_DATE;";
