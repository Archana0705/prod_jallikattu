...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT COMMITEE_ID, INSPECTION_DATE, COMMITEE_DEPARTMENT, COMMITEE_NAME, COMMITEE_DESIGNATION, COMMITEE_MAIL, COMMITEE_MOBILE, STATUS, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, EVENT_ID from TNEA_JALLIKATTU_MONITORING_COMMITEE_REGISTERATION_T where event_id=:P55_EVENT_ID;";
    $stmt = $jk_read_db->prepare($sql);
    $stmt->bindParam(':P55_EVENT_ID', $event_id, PDO::PARAM_INT);
    if ($stmt->execute()) {
