...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT b.BULLS_ID, b.EVENT_TYPE, b.EVENT_DATE, b.PLACE_OF_EVENT, b.DISTRICT, b.STATUS, b.CREATED_BY, b.CREATED_DATE, b.UPDATED_DATE, b.UPDATED_BY, b.SELECTED_BULL, b.MOBILE
    FROM TNEA_JALLIKATTU_BULL_EVENT_T b
    INNER JOIN TNEA_JALLIKATTU_APPROVER_LOGIN_T a ON a.district = b.DISTRICT
    WHERE  b.STATUS = 'Y'  AND b.REQUEST_STATUS = 'S'  AND a.approver_id = :app_employee_id
    ORDER BY b.EVENT_DATE DESC, b.BULLS_ID ASC;";
