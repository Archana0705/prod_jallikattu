...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $R_status = 'N';
    $sql = "UPDATE TNEA_JALLIKATTU_EVENT_REGISTERATION_T SET Request_status = :Request_status,forward_to=:P9_CREATED_BY,MHS_COMMENTS=:P9_MHS_COMMENTS,updated_by=:app_employee_id WHERE EVENT_ID = :P9_EVENT_ID;";

    $bind = $jk_write_db->prepare($sql);
    $bind->bindParam(':Request_status', $R_status);
    $bind->bindParam(':P9_CREATED_BY', $user_id);
