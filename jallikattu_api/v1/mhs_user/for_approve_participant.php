...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    FROM TNEA_JALLIKATTU_PART_EVENT_T p
    JOIN TNEA_JALLIKATTU_APPROVER_LOGIN_T a ON a.DISTRICT = p.DISTRICT
    WHERE p.STATUS = 'Y' AND p.REQUEST_STATUS IN ('S') AND a.APPROVER_ID = :app_employee_id
