...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE TNEA_JALLIKATTU_EVENT_REGISTERATION_T SET Request_status = :Request_status,forward_to = :forward,updated_by=:app_employee_id WHERE EVENT_ID = :P52_EVENT_ID;";
    ...
    $bind->bindParam(':P52_EVENT_ID', $event_id);
    if ($bind->execute()) {
