...
require_once('../../helper/participant_approved_send_sms.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($user_id) || empty($mobile_numbers)) {
        http_response_code(400);
        echo json_encode(["success" => 0, "message" => "Missing required fields: user_id or mobile_no"]);
        die();
    }
