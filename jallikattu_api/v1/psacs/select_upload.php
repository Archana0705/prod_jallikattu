...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT GO_ID,EVENT_ID,EVENT_DATE,NAME_OF_ORGANIZATION,COMMITEE_REGISTER_NUMBER,NAME_OF_president,CONTACT_OF_PRESIDENT,MOBILE_OF_PRESIDENT,NAME_OF_VILLAGE,NAME_OF_TALUK,NAME_OF_DISTRICT,PINCODE,GO,GO_ATTACH_MIMETYPE,GO_ATTACH_FILENAME,STATUS,CREATED_BY,CREATED_DATE,UPDATED_BY,UPDATED_DATE,EVENT_TYPE,PLACE_EVENT,GO_NUMBER from TNEA_JALLIKATTU_EVENT_GO_T;";
