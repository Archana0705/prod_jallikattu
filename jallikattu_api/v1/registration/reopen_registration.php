...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $data = [
        ...
        "message" => $stmt->execute() ? "Data successfully inserted." : "Error inserting data."
    ];
