...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    SET
        Request_status = :REQUEST_STATUS,forward_to= :forward,DAH_VS_COMMENTS=:P82_DAH_VS_COMMENTS,updated_by=:app_employee_id
    WHERE
        EVENT_ID = :P19_EVENT_ID;";
    $bind = $jk_write_db->prepare($sql);
    $bind->bindParam(':REQUEST_STATUS', $R_status);
    $bind->bindParam(':forward', $fwdTo);
    $bind->bindParam(':P82_DAH_VS_COMMENTS', $comments);
